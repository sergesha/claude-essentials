...
## [0.9.2](https://github.com/sergesha/claude-essentials/compare/redis-memory-mcp-v0.9.1...redis-memory-mcp-v0.9.2) (2026-09-13)
...
* **redis-memory-mcp:** support Codex and migrate to MCP SDK 2 ([72b6655](https://github.com/sergesha/claude-essentials/commit/72b6655ad2c6e03662a9bb4da9aa5958b9a7c7ef))
