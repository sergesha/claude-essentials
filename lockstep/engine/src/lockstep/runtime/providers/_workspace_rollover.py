...
class WorkspaceRolloverTransaction:
    ...
    def _quarantine_for_rollover(
        ...
        self._write_record(quarantined, snapshot_ref_out=None)
        return quarantined
    ...
    def _rebind_relocated_workspace(
        ...
        self._write_record(rebound, snapshot_ref_out=None)
        return rebound
    ...
    def _commit_rollover(self, current: WorkspaceLease, rolled) -> str:
        ...
        self._write_record(completed, snapshot_ref_out=result_ref)
        return result_ref
